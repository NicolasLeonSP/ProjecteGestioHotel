...
public class Factura {
    ...
    // Esta funcion SQL se encarga de revisar si el cliente tiene una tarjeta de credito. Ir a la linea 933 del modelo para mas info
    ...
    // Esta funcion SQL se encarga de subir la factura a la base de datos. Ir a la linea 933 del modelo para mas info
    ...
    // Esta funcion SQL se encarga de editar una factura ya existente en la base de datos, modificando el metodo de pago. Ir a la linea 933 del modelo para mas info
